...
public class AnimatedIcon implements Icon {
   ...
   @SuppressWarnings({ "rawtypes", "unchecked" })
	private static Map<Image, Boolean> decoded = new WeakHashMap();
               ...
               if (is == null) {
                   try {
                       ...
                       if (p instanceof InputStreamImageSource) {
                    	   Class<Object> temp = null;
                           Method m = InputStreamImageSource.class.getDeclaredMethod("getDecoder", temp);
                           m.setAccessible(true);
                           ImageDecoder d = (ImageDecoder)m.invoke(p, temp);
